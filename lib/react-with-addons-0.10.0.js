   ...
   *   }
        ...
        function mixSpecIntoComponent(ConvenienceConstructor, spec) {
            ...
            for (var name in spec) {
                ...
                if (RESERVED_SPEC_KEYS.hasOwnProperty(name)) {
                    ...
                    var shouldAutoBind =
                        isFunction && !isCompositeComponentMethod && !isInherited && !markedDontBind;
        ...
        var ReactCompositeComponentMixin = {
            ...
            _performUpdateIfNecessary: function (transaction) {
                if (this._pendingProps == null &&
                    this._pendingState == null &&
                    this._pendingContext == null && !this._pendingForceUpdate) {
                    return;
                }
                ...
                try {
                    if (this._pendingForceUpdate || !this.shouldComponentUpdate ||
   ...
   *   })(1);
        ...
        var ReactTestUtils = {
            ...
            isDOMComponent: function (inst) {
                return !!(inst &&
                    ReactComponent.isValidComponent(inst) && !!inst.tagName);
            },
